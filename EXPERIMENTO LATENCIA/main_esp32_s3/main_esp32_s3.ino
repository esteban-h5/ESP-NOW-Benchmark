...
//////////////////////////////////////////////////
// uint8_t PeerActual = 1; // Peer E1 ROJO
uint8_t PeerActual = 2; // Peer E2 NEGRO
//////////////////////////////////////////////////

//uint8_t mac_broadcast[] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff}

//E1  : 7C:DF:A1:FF:2B:30 rojo
//E2  : 68:B6:B3:21:09:E8 negro

uint8_t mac_addr_E1[] = {0x7C, 0xDF, 0xA1, 0xFF, 0x2B, 0x30};
uint8_t mac_addr_E2[] = {0x68, 0xB6, 0xB3, 0x21, 0x09, 0xE8};
