...
//////////////////////////////////////////////////
uint8_t PeerActual = 1; // Peer E1 EMISOR MAESTRO
// uint8_t PeerActual = 2; // Peer E2 RECEPTOR ESCLAVO
//////////////////////////////////////////////////

//uint8_t mac_broadcast[] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff}

// uint8_t mac_addr_E1[] = {0x7C, 0xDF, 0xA1, 0xFF, 0x2B, 0x30}; //ESP32-S3 E1
uint8_t mac_addr_E1[] = {0xB8, 0xD6, 0x1A, 0xAB, 0x4D, 0x8C}; //ESP32 E1

uint8_t mac_addr_E2[] = {0x68, 0xB6, 0xB3, 0x21, 0x09, 0xE8}; //ESP32-S3 E2
// uint8_t mac_addr_E2[] = {0xB8, 0xD6, 0x1A, 0xAC, 0x03, 0x60}; //ESP32 E2
